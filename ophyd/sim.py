...
class HardwareBundle:
    ...
    sig: Signal
    det_with_conf: DetWithConf
    det_with_count_time: DetWithCountTime
    rand: SynPeriodicSignal
    rand2: SynPeriodicSignal
    motor_no_pos: SynAxisNoPosition
    motor_empty_hints1: SynAxisEmptyHints
    motor_empty_hints2: SynAxisEmptyHints
    motor_no_hints1: SynAxisNoHints
    motor_no_hints2: SynAxisNoHints
    bool_sig: Signal
    signal: SynSignal

def hw(save_path=None) -> HardwareBundle:
...
# motor2=_hw.motor2
# motor3=_hw.motor3
# jittery_motor1=_hw.jittery_motor1
# jittery_motor2=_hw.jittery_motor2
# noisy_det=_hw.noisy_det
# det=_hw.det
# identical_det=_hw.identical_det
# det1=_hw.det1
# det2=_hw.det2
# det3=_hw.det3
# det4=_hw.det4
...
# flyer1=_hw.flyer1
# flyer2=_hw.flyer2
# trivial_flyer=_hw.trivial_flyer
# new_trivial_flyer=_hw.new_trivial_flyer
# ab_det=_hw.ab_det
# direct_img=_hw.direct_img
# direct_img_list=_hw.direct_img_list
# img=_hw.img
# invariant1=_hw.invariant1
# invariant2=_hw.invariant2
# pseudo3x3=_hw.pseudo3x3
# pseudo1x3=_hw.pseudo1x3
# sig=_hw.sig
# det_with_conf=_hw.det_with_conf
# det_with_count_time=_hw.det_with_count_time
# rand=_hw.rand
# rand2=_hw.rand2
# motor_no_pos=_hw.motor_no_pos
# motor_empty_hints1=_hw.motor_empty_hints1
# motor_empty_hints2=_hw.motor_empty_hints2
# motor_no_hints1=_hw.motor_no_hints1
# motor_no_hints2=_hw.motor_no_hints2
# bool_sig=_hw.bool_sig
# signal=_hw.signal
